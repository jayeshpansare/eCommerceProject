...
Feature: Validate category page
  ...
  Scenario Outline: validate category and its related products
    ...
    Examples:
      ...
      | Electronics          | Bose QuietComfort 45 Bluetooth Wireless Headphones#WD 5TB Elements Portable External Hard Drive HDD#Oculus Quest 2 - Advanced All-In-One Virtual Reality Headset                                                                                                                                                                                                               |
  ...
  Scenario Outline: validate sub category and its related products
    ...
    Examples:
      ...
      | Electronics | Computers         | WD 5TB Elements Portable External Hard Drive HDD                                                                                                                                                                                                                           |
